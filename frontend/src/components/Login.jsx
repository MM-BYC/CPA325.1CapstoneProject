    ...
    <div className="parentContainer">
      <div className="childContainerLeft ">
        ...
        <div className="childContainerLeft childContainerDetail">
          ...
          <h3>
            Whether you’re organizing an event, coordinating with your team, or
            scheduling appointments with clients… our system simplifies the
          ...
          <p className="indented-text">
            ...
            efficiently. Keep track of deadlines and ensure smooth collaboration
          ...
          <h3>For Clients:</h3>
          <p className="indented-text">
            Offer your clients the convenience of booking appointments at their
            preferred times. Enhance your service by providing a seamless
